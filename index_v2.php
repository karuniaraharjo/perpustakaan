...
<body>
    <div class="card">
        ...
        <div class="info">
            ...
            <p><strong>Dibuat oleh:</strong> <?php echo "Karunia Raharjo"; ?></p>
        ...
        $alamat_perpus   = "Jl. Merdeka No. 123, Batang";
        ...
        <div class="info">
            ...
            <p><strong>No telepon:</strong> <?php echo $telepon_perpus; ?></p>
            <p><strong>Jam Operasional:</strong> <?php echo $jam_buka." - ".$jam_tutup ?> WIB</p>
